...
$ openproblems-cli image --methods --task label_projection logistic_regression_scran
op-r-base
$ docker run -dt singlecellopenproblems/op-r-base openproblems-cli run --task label_projection --input dataset.h5ad --output method.h5ad logistic_regression_log_cpm
$ openproblems-cli list --metrics --task label_projection
accuracy
f1
f1_micro
